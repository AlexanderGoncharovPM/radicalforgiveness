const questions = [
  ...
  },
  {
    ...
    "note": "Примітка: Це твердження нагадує нам про те, що ніхто не може змусити нас відчувати що б то не було. Наші емоції належать нам. Коли людина відчуває ,визнає , приймає та любить їх без жодних додаткових умов , він тим самим знаходить повну свободу залишити їх при собі або відпустити. Усвідомлення цього робить нас сильнішими , оскільки допомагає зрозуміти, що джерело проблеми знаходиться не у зовнішньому світі, а всередині нас самих. І ще це усвідомлення – наш перший крок уйти геть від вібрацій архетипу жертви .Вважаючи, що інші люди або навіть ситуації здатні викликати в нас злість ,радість , смуток або страх, ми тим самим віддаємо їм усю свою силу.",
    "hints_from": [
      "your_storry",
      "real_emotions"
    ]
